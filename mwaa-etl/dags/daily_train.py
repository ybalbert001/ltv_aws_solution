...
with DAG(
    ...
    begin >> task_create_table >> task_combine_data >> [task_gen_feature1, task_gen_feature2, task_gen_label] >> task_gen_dataset >> [task_gen_classification_model, task_gen_regression_model] >> wait_for_while >> task_eval_model >> end
