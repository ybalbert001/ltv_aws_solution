DROP MODEL IF EXISTS ltv_regression_auto_model_v1_{{ ds_nodash }};
CREATE MODEL ltv_regression_auto_model_v1_{{ ds_nodash }} 
FROM
    (
...
today_order_amount, today_agv_amount_per_order, today_std_amount_per_order, today_max_amount_per_order, label 
